...
const mockMovies: Movie[] = [
  { id: '1', title: 'The Stellar Voyage', duration: 142, genre: 'Sci-Fi', rating: 'PG-13' },
  { id: '2', title: 'Midnight in Paris Redux', duration: 118, genre: 'Drama', rating: 'PG' },
  { id: '3', title: 'Action Heroes', duration: 135, genre: 'Action', rating: 'R' },
  { id: '4', title: 'The Last Garden', duration: 156, genre: 'Drama', rating: 'PG-13' },
];
...
const mockScreenings: Screening[] = [
  { id: '1', movieId: '1', cinemaId: '1', datetime: '2025-11-04T14:30:00', price: 12 },
  { id: '2', movieId: '1', cinemaId: '1', datetime: '2025-11-04T19:00:00', price: 15 },
  { id: '3', movieId: '2', cinemaId: '2', datetime: '2025-11-04T16:00:00', price: 11 },
  { id: '4', movieId: '3', cinemaId: '3', datetime: '2025-11-04T20:30:00', price: 14 },
  { id: '5', movieId: '1', cinemaId: '2', datetime: '2025-11-05T15:00:00', price: 12 },
  { id: '6', movieId: '4', cinemaId: '1', datetime: '2025-11-06T18:00:00', price: 13 },
  { id: '7', movieId: '2', cinemaId: '3', datetime: '2025-11-07T17:30:00', price: 12 },
  { id: '8', movieId: '3', cinemaId: '2', datetime: '2025-11-08T21:00:00', price: 15 },
  { id: '9', movieId: '4', cinemaId: '3', datetime: '2025-11-10T19:30:00', price: 13 },
  { id: '10', movieId: '1', cinemaId: '3', datetime: '2025-11-15T20:00:00', price: 14 },
];
...
function App() {
  ...
  const getFilteredScreenings = () => {
    ...
    return screenings.filter(s => {
      ...
      switch (dateRange) {
        case 'today':
          return screeningDate >= todayStart && screeningDate < todayEnd;
        case 'thisWeek':
          return screeningDate >= todayStart && screeningDate <= weekEnd;
        case 'anytime':
          return true;
        case 'custom':
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        {filteredScreenings.length === 0 ? (
          <div className="bg-neutral-800 rounded-lg p-12 text-center">
            ...
            <p className="text-xl text-neutral-400">No screenings found for the selected date range</p>
          </div>
        ) : groupBy === 'movie' ? (
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {Object.entries(groupByMovie(filteredScreenings)).map(([movieId, movieScreenings]) => {
                ...
                <div key={movieId} className="bg-neutral-800 rounded-lg p-6">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-sm font-semibold text-neutral-300">
                      {movieScreenings.length} Screening{movieScreenings.length !== 1 ? 's' : ''}
                    </h4>
                    {movieScreenings
                      ...
                      .map(screening => {
                        ...
                        return (
                          <div key={screening.id} className="bg-neutral-700 rounded p-3 text-sm">
                            <div className="flex justify-between items-start">
                              <div>
                                <p className="font-medium">{cinema?.name}</p>
                                <p className="text-neutral-400">{formatDate(screening.datetime)}</p>
                              </div>
                              <div className="text-right">
                                <p className="text-neutral-300">{formatTime(screening.datetime)}</p>
                                <p className="text-red-500 font-semibold">${screening.price}</p>
                              </div>
                            </div>
                          </div>
                        );
          ...
          <div className="space-y-8">
            {Object.entries(groupByCinema(filteredScreenings)).map(([cinemaId, cinemaScreenings]) => {
                  ...
                  <div className="space-y-4">
                    {cinemaScreenings
                      ...
                      .map(screening => {
                        ...
                        return (
                          <div key={screening.id} className="bg-neutral-700 rounded p-4 flex justify-between items-center">
                            <div>
                            ...
                            <div className="text-right">
                              ...
                              <div className="text-sm text-neutral-400">{formatDate(screening.datetime)}</div>
                              <div className="text-red-500 font-semibold mt-1">${screening.price}</div>
                            </div>
                          </div>
                        );
                      })}
